...
include('conexao.php');
try {
    $sql = "insert into tblvendaprodutos (idproduto,qtd,idcliente) values (:idproduto,:qtd,:idcliente)";
    $stmt = $con->prepare($sql);
    $stmt-> bindValue(":idproduto",$_POST["idproduto"]);
    $stmt-> bindValue(":qtd",$_POST["qtd"]);
    $stmt-> bindValue(":idcliente",$_POST["idcliente"]);
    $stmt->execute();
    header("location:listarvendaprodutos.php");
...
<html lang="pt-br">
  ...
  <div class="container-fluid">
    <a class="navbar-brand" href="#"><h2>Vendas Produtos</h2></a>

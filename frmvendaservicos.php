...
include('conexao.php');
try {
    $sql = "insert into tblvendaservicos (idservico,idcomissionado,idcliente) values (:idservico,:idcomissionado,:idcliente)";
    $stmt = $con->prepare($sql);
    $stmt-> bindValue(":idservico",$_POST["idservico"]);
    $stmt-> bindValue(":idcomissionado",$_POST["idcomissionado"]);
    $stmt-> bindValue(":idcliente",$_POST["idcliente"]);
    $stmt->execute();
    header("location:listarvendaservicos.php");
...
<html lang="pt-br">
  ...
  <div class="container-fluid">
    <a class="navbar-brand" href="#"><h2>Venda de Serviços</h2></a>
...
<form method="post">
        ...
        <div class="mb-3">
            ...
            <label for="exampleInputEmail1" class="form-label">Código do Serviço:</label>
            <input type="text" name="idservico"><br><br>       
        ...
        <div class="mb-3">
                ...
                <label for="exampleInputPassword1" class="form-label">Nº do Prestador:</label>
                <input type="text" name="idcomissionado"><br><br>
        ...
        <div class="mb-3">
                ...
                <label for="exampleInputPassword1" class="form-label">Nº do Cliente:</label>

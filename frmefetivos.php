...
include('conexao.php');
try {
    $sql = "insert into tblefetivos (nome,funcao,dtadmissao,salario) values (:nome,:funcao,:dtadmissao,:salario)";
    $stmt = $con->prepare($sql);
    $stmt-> bindValue(":nome",$_POST["nome"]);
    $stmt-> bindValue(":funcao",$_POST["funcao"]);
    $stmt-> bindValue(":dtadmissao",$_POST["dtadmissao"]);
    $stmt-> bindValue(":salario",$_POST["salario"]);
    $stmt->execute();
    header("location:listarefetivos.php");
...
<html lang="pt-br">
  <head>
    ...
    <title>Funcionários Efetivos</title>
  </head>
  <body>
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <div class="container-fluid">
    <a class="navbar-brand" href="#"><h2>Funcionários Efetivos</h2></a>
...
<form method="post">
        ...
        <div class="mb-3">
                ...
                <label for="exampleInputPassword1" class="form-label">Função:</label>
        ...
        <div class="mb-3">
                ...
                <label for="exampleInputPassword1" class="form-label">Admissão:</label>

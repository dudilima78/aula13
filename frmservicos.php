...
include('conexao.php');
try {
    $sql = "insert into tblservicos (servico,duracao,preco,comissao) values (:servico,:duracao,:preco,:comissao)";
    $stmt = $con->prepare($sql);
    $stmt-> bindValue(":servico",$_POST["servico"]);
    $stmt-> bindValue(":duracao",$_POST["duracao"]);
    $stmt-> bindValue(":preco",$_POST["preco"]);
    $stmt-> bindValue(":comissao",$_POST["comissao"]);
    $stmt->execute();
...
<html lang="pt-br">
  ...
  <div class="container-fluid">
    <a class="navbar-brand" href="#"><h2>Cadastro de Serviços</h2></a>
...
<form method="post">
        ...
        <div class="mb-3">
                ...
                <label for="exampleInputPassword1" class="form-label">Comissão:</label>
                <input type="text" name="comissao"><br><br>
